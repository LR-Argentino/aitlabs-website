...
export class AiAutomationsComponent {
  ...
  useCases = [
    ...
    },
    {
      ...
      description: 'Systems monitor data streams, detect anomalies (fraud attempts, outliers, security risks), and trigger actions.',
      details: '',
      icon: 'shield'
    },
    {
      title: 'Workflow Automation',
      description: 'Approval processes, contract sign-offs, employee onboarding – fully automated and documented.',
      details: '',
      icon: 'workflow'
    }
  ];
  ...
  howItWorksSteps = [
    ...
    },
    {
      ...
      description: 'Based on AI models, RAG systems, or predefined rules, the system decides which action to take.',
      icon: 'brain'
    },
    {
      title: 'Execution',
      description: 'Integration with existing systems (CRM, ERP, HR, Finance, Email, Slack, Teams, etc.) executes the tasks.',
      icon: 'execute'
    }
  ];
  ...
  realWorldExample = {
    ...
    processes: [
      ...
      {
        title: 'Support',
        description: 'Emails with standard questions ("Where is my package?") are answered automatically.',
        icon: 'support'
      },
      {
        title: 'Returns',
        description: 'Requests are detected, validated, and either approved automatically or escalated.',
        icon: 'return'
      }
    ],
    results: [
  ...
  faqs = [
    ...
    },
    {
      ...
      answer: 'Automations include checkpoints and fallbacks. Uncertain cases are escalated to staff.'
    },
    {
      question: 'How long does implementation take?',
      answer: 'Initial processes can often be automated in 2–4 weeks. More complex workflows follow step by step.'
    },
    {
      question: 'Can the system connect to my existing tools?',
      answer: 'Yes. Through APIs, integrations & webhooks, we connect with Salesforce, HubSpot, SAP, Microsoft, Google Workspace, Slack, and many more.'
    }
  ];
